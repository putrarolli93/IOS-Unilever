...
class MyOrderRequest {
    ...
    func req() {
        Alamofire.request("\(BaseUrl.baseUrl)commerce/unilever-middleware/core-services/Order/list/outletId/\(UserDefaults.standard.array(forKey: "session")![0])").responseJSON { response in
